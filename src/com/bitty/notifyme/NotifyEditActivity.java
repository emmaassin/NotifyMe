...
public class NotifyEditActivity extends Activity {

	private TextView title, trainsText, daysText, title2;
	private LinearLayout linesButton, daysButton;
	private TimePicker timePicker;
	private Button saveButton, cancelButton;
	private OtherDaysDialog daysDialog;
	private TrainLinesDialog linesDialog;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View view) {
        		saveState(); 
        		setResult(RESULT_OK);
        	    Toast.makeText(NotifyEditActivity.this, getString(R.string.notification_saved_message), Toast.LENGTH_SHORT).show();
        	    finish(); 
        	}
        });
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View view) { 
        	    Toast.makeText(NotifyEditActivity.this, getString(R.string.notification_cancel_message), Toast.LENGTH_SHORT).show();
        	    finish(); 
        	}
        });
	...
	private void makeLinesPopup() {
		linesDialog = new TrainLinesDialog(this);
	...
	{
		daysDialog = new OtherDaysDialog(this);
		if(daysArray.size() > 0)
		{
	...
	private void saveState() {
        ...
        {
        	reminderMgr.setReminder(hr, min, daysPositionArray.indexOf(daysArray.get(i))+1);
        }
	}
}
